...
PHONE_ID = os.getenv("PHONE_ID") or os.getenv("PHONE_NUMBER_ID") or os.getenv("PHONE_ID_2")
VERIFY_TOKEN = os.getenv("VERIFY_TOKEN", "bob123")
LLM_API_KEY = os.getenv("LLM_API_KEY") or os.getenv("GOOGLE_API_KEY") or os.getenv("GEMINI_API_KEY") or os.getenv("OPENAI_API_KEY")
